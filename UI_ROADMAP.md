...
**Pages (11):** Dashboard · Subjects · Tasks · Study Timer · Attendance · Analytics · Notes · Community · Friends · Trophies & XP · Profile. Plus a separate Owner panel.

**Modals (16):** task, note, session, manual session, leave, roadmap, prompt, attachment, add-attach, daily goal, matrix columns, matrix log, add friend, friend requests, friends list, content view.

**What is genuinely absent today:** Settings page · light theme / theme toggle · global search or command palette · notifications / activity feed · data import · calendar-agenda view · onboarding · pomodoro · contribution heatmap · `aria-live` regions · `role="dialog"` on modals.

---

## 2. Priority tiers

### Tier 1 — Fills a real hole (build first)
...
| 1.5 | **Notification / activity centre** | topbar bell + dropdown panel | Friend requests already have a nav badge but no inbox. Overdue tasks, streak-at-risk, pending timers and received files have nowhere to surface. |
...
### Tier 2 — Strong additions to pages that already work
